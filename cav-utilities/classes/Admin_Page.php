...
final class Admin_Page
{
   ...
   public function adds_notice(): void
   {
      ...
      $text = match ($notice) {
         'test_mail-yes' => esc_html__('The test mail was sent without errors.', 'cav-utilities'),
         'test_mail-no'  => esc_html__('The test mail was not sent. An error occurred.', 'cav-utilities'),
         default         => false,
      };
   ...
   public function adds_settings_links($actions)
   {
      ...
      $actions[] = [
         '<a href="#" target="_blank">' . esc_html__('Contribute', 'cav-utilities') . '</a>',
      ];
